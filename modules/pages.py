        ...
        if not employee_map:
            ...
            if not summary:
                ...
                if not verified:
                    ...
                    if st.button("Review & Verify", type="primary", width="stretch", key="payroll_hr_review_btn"):
                    ...
                    if st.button("← Back to edit", key="payroll_hr_back_btn"):
                        ...
                        st.rerun()
                    c1, c2 = st.columns(2)
                    if c1.button("Confirm & Save as Draft", type="primary", width="stretch", key="payroll_hr_save_draft"):
